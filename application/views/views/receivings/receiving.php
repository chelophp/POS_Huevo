							...
							<?php echo form_open("receivings/add",array('id'=>'add_item_form', 'autocomplete'=> 'off')); ?>
								<?php echo form_input(array('name'=>'item','id'=>'item','size'=>'30','placeholder'=>'Enter item name or scan barcode'));?>
									...
									<?php echo anchor("receivings/suspended/",
										...
										array('class'=>'btn btn-primary none suspended_recvs_btn','title'=>lang('sales_suspended_sales')));
										?>
					...
					<div class="table-responsive">
						...
						<tbody id="cart_contents">
							...
							<tr class="cart_content_area">
								<td colspan='7' style="height:60px;border:none;">
			...
			<li class="list-group-item nopadding">
				...
				<div class="sale_form_main"   <?php if(count($cart) > 0){ echo "style='visibility: visible;'";}?>>
					<?php	if(count($cart) > 0){ ?>
						...
						<input type="button" class="btn btn-warning warning-buttons" id="suspend_recv_button" value="<?php echo lang('receivings_suspend_recv');?>" />

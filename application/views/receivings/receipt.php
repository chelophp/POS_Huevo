...
<div id="receipt_wrapper">
	...
	<tr>
	<th style="width:50%;text-align:left;"><?php echo lang('items_item'); ?></th>
	<th style="width:17%;text-align:left;"><?php echo lang('common_price'); ?></th>
	<th style="width:16%;text-align:left;"><?php echo lang('sales_quantity'); ?></th>
	...
	?>
		<tr>
		<td style="text-align:left;"><?php echo character_limiter(H($item['name']),25); ?></td>
		<td style="text-align:left;"><?php echo to_currency($item['price'], 10); ?></td>
		<td style='text-align:left;'><?php echo $item['quantity']; ?></td>
		<td style='text-align:left;'><?php echo $item['discount']; ?></td>
		<td style='text-align:right;'><?php echo to_currency($item['price']*$item['quantity']-$item['price']*$item['quantity']*$item['discount']/100, 10); ?></td>
		</tr>
	    <tr>
	...
	<td colspan="2" style='text-align:right'><?php echo to_currency($total, 10); ?></td>
	</tr>
	...
	?>
		...
		<td colspan="2" style='text-align:right'><?php echo to_currency($amount_tendered, 10); ?></td>
		</tr>

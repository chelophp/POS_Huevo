		...
		<div class="col-md-12">
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					...
					<div class="form-group">
					<?php echo form_label('Tipo de Producto:', 'id_items_tipo',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required wide')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_dropdown('id_items_tipo',$opt_items_tipo, $item_info->id_items_tipo, 'class="form-control form-inps" id="id_items_tipo"');?>
						</div>
					</div>					
